...
if ($ADMIN->fulltree) {
    ...
    /////// Footer row 1
    $page->add(new admin_setting_heading('theme_edumy/footer_row_1', get_string('footer_row_1', 'theme_edumy'), NULL));

    ///// Footer column 1
    $page->add(new admin_setting_heading('theme_edumy/footer_row_1_col_1', "&nbsp;&nbsp;" . get_string('footer_col_1', 'theme_edumy'), NULL));
    // Footer column 1 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_1_col_1_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Mobile', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 2
    $page->add(new admin_setting_heading('theme_edumy/footer_row_1_col_2', "&nbsp;&nbsp;" . get_string('footer_col_2', 'theme_edumy'), NULL));
    // Footer column 2 icon 1
    $setting = new admin_setting_configstoredfile('theme_edumy/footer_row_1_col_2_icon_1', get_string('footer_col_icon','theme_edumy'), get_string('footer_col_icon_desc', 'theme_edumy'), 'footer_row_1_col_2_icon_1');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 2 icon 2
    $setting = new admin_setting_configstoredfile('theme_edumy/footer_row_1_col_2_icon_2', get_string('footer_col_icon','theme_edumy'), get_string('footer_col_icon_desc', 'theme_edumy'), 'footer_row_1_col_2_icon_2');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 2 icon 3
    $setting = new admin_setting_configstoredfile('theme_edumy/footer_row_1_col_2_icon_3', get_string('footer_col_icon','theme_edumy'), get_string('footer_col_icon_desc', 'theme_edumy'), 'footer_row_1_col_2_icon_3');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 3
    $page->add(new admin_setting_heading('theme_edumy/footer_row_1_col_3', "&nbsp;&nbsp;" . get_string('footer_col_3', 'theme_edumy'), NULL));
    // Footer column 3 icon 1
    $setting = new admin_setting_configstoredfile('theme_edumy/footer_row_1_col_3_icon_1', get_string('footer_col_icon','theme_edumy'), get_string('footer_col_icon_desc', 'theme_edumy'), 'footer_row_1_col_3_icon_1');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 3 icon 2
    $setting = new admin_setting_configstoredfile('theme_edumy/footer_row_1_col_3_icon_2', get_string('footer_col_icon','theme_edumy'), get_string('footer_col_icon_desc', 'theme_edumy'), 'footer_row_1_col_3_icon_2');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    //////// Footer row 2
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2', get_string('footer_row_2', 'theme_edumy'), NULL));

    ///// Footer column 1
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2_col_1', "&nbsp;&nbsp;" . get_string('footer_col_1', 'theme_edumy'), NULL));
    // Footer column 1 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_2_col_1_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Contact', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 1 body
    $setting = new admin_setting_configtextarea('theme_edumy/footer_row_2_col_1_body', get_string('footer_col_body','theme_edumy'), get_string('footer_col_body_desc', 'theme_edumy'), 'Body text for the first column.', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 2
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2_col_2', "&nbsp;&nbsp;" . get_string('footer_col_2', 'theme_edumy'), NULL));
    // Footer column 2 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_2_col_2_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Company', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column body
    $setting = new admin_setting_configtextarea('theme_edumy/footer_row_2_col_2_body', get_string('footer_col_body','theme_edumy'), get_string('footer_col_body_desc', 'theme_edumy'), 'Body text for the second column.', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 3
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2_col_3', "&nbsp;&nbsp;" . get_string('footer_col_3', 'theme_edumy'), NULL));
    // Footer column 3 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_2_col_3_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Programs', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 3 body
    $setting = new admin_setting_configtextarea('theme_edumy/footer_row_2_col_3_body', get_string('footer_col_body','theme_edumy'), get_string('footer_col_body_desc', 'theme_edumy'), 'Body text for the third column.', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 4
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2_col_4', "&nbsp;&nbsp;" . get_string('footer_col_4', 'theme_edumy'), NULL));
    // Footer column 4 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_2_col_4_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Support', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column body
    $setting = new admin_setting_configtextarea('theme_edumy/footer_row_2_col_4_body', get_string('footer_col_body','theme_edumy'), get_string('footer_col_body_desc', 'theme_edumy'), 'Body text for the fourth column.', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    ///// Footer column 5
    $page->add(new admin_setting_heading('theme_edumy/footer_row_2_col_5', "&nbsp;&nbsp;" . get_string('footer_col_5', 'theme_edumy'), NULL));
    // Footer column 5 title
    $setting = new admin_setting_configtext('theme_edumy/footer_row_2_col_5_title', get_string('footer_col_title','theme_edumy'), get_string('footer_col_title_desc', 'theme_edumy'), 'Mobile', PARAM_NOTAGS, 50);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    // Footer column 5 body
    $setting = new admin_setting_configtextarea('theme_edumy/footer_row_2_col_5_body', get_string('footer_col_body','theme_edumy'), get_string('footer_col_body_desc', 'theme_edumy'), 'Body text for the fifth column.', PARAM_RAW);
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    ...
    $page->add(new admin_setting_heading('theme_edumy/course_colors', get_string('course_colors', 'theme_edumy'), NULL));
    
    // Course Category Color First
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_category_first_color', get_string('course_category_first_color','theme_edumy'), get_string('course_sixth_color_desc', 'theme_edumy'), '#9E00FF');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Course Category Color Second
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_category_second_color', get_string('course_category_second_color','theme_edumy'), get_string('course_sixth_color_desc', 'theme_edumy'), '#0A47C9');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Course Category Color Third
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_category_third_color', get_string('course_category_third_color','theme_edumy'), get_string('course_sixth_color_desc', 'theme_edumy'), '#9E00FF');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Course Color First
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_first_color', get_string('course_first_color','theme_edumy'), get_string('course_first_color_desc', 'theme_edumy'), '#428EC5');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Course Color Second
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_second_color', get_string('course_second_color','theme_edumy'), get_string('course_second_color_desc', 'theme_edumy'), '#FBADAF');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Course Color Third
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_third_color', get_string('course_third_color','theme_edumy'), get_string('course_third_color_desc', 'theme_edumy'), '#7ABAAB');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Course Color Forth
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_forth_color', get_string('course_forth_color','theme_edumy'), get_string('course_forth_color_desc', 'theme_edumy'), '#ED6D6E');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Course Color Fifth
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_fifth_color', get_string('course_fifth_color','theme_edumy'), get_string('course_fifth_color_desc', 'theme_edumy'), '#9673B3');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);

    // Course Color Sixth
    $setting = new admin_setting_configcolourpicker('theme_edumy/course_sixth_color', get_string('course_sixth_color','theme_edumy'), get_string('course_sixth_color_desc', 'theme_edumy'), '#FDCB80');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    ///// Course Badges settings
    $page->add(new admin_setting_heading('theme_edumy/course_badge_settings', get_string('course_badges', 'theme_edumy'), NULL));
    
    // Common Course Badge
    $setting = new admin_setting_configstoredfile('theme_edumy/coursebadge_common', get_string('course_common_badge', 'theme_edumy'), get_string('course_common_badge_desc', 'theme_edumy'), 'coursebadge_common');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Enrolled Course Badge
    $setting = new admin_setting_configstoredfile('theme_edumy/coursebadge_enrolled', get_string('course_enrolled_badge', 'theme_edumy'), get_string('course_enrolled_badge_desc', 'theme_edumy'), 'coursebadge_enrolled');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    ///// Course Icons settings
    $page->add(new admin_setting_heading('theme_edumy/course_icons_settings', get_string('course_icons', 'theme_edumy'), NULL));
    
    // Book Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_book', get_string('course_book_icon', 'theme_edumy'), get_string('course_book_icon_desc', 'theme_edumy'), 'courseicon_book');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Chat Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_chat', get_string('course_chat_icon', 'theme_edumy'), get_string('course_chat_icon_desc', 'theme_edumy'), 'courseicon_chat');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Download Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_download', get_string('course_download_icon', 'theme_edumy'), get_string('course_download_icon_desc', 'theme_edumy'), 'courseicon_download');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Followers Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_followers', get_string('course_followers_icon', 'theme_edumy'), get_string('course_followers_icon_desc', 'theme_edumy'), 'courseicon_followers');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Plus Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_plus', get_string('course_plus_icon', 'theme_edumy'), get_string('course_plus_icon_desc', 'theme_edumy'), 'courseicon_plus');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Return Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_return', get_string('course_return_icon', 'theme_edumy'), get_string('course_return_icon_desc', 'theme_edumy'), 'courseicon_return');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
    
    // Share Course Icon
    $setting = new admin_setting_configstoredfile('theme_edumy/courseicon_share', get_string('course_share_icon', 'theme_edumy'), get_string('course_share_icon_desc', 'theme_edumy'), 'courseicon_share');
    $setting->set_updatedcallback('theme_reset_all_caches');
    $page->add($setting);
  ...
  // Quiz layout
    ...
    $setting = new admin_setting_configselect('theme_edumy/primary_font',
        ...
        get_string('primary_font_desc', 'theme_edumy'), 0,
            array('0' => 'Open Sans',
                  '1' => 'Josefin Sans',
                  '2' => 'Nunito',
                  '3' => 'Dosis',
    ...
    $setting = new admin_setting_configselect('theme_edumy/secondary_font',
        ...
        get_string('secondary_font_desc', 'theme_edumy'), 1,
            array('0' => 'Open Sans',
                '1' => 'Josefin Sans',
                '2' => 'Nunito',
                '3' => 'Dosis',
