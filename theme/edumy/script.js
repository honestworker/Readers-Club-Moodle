  ...
  (function($) {
    ...
    $(document).on('ready', function() {
      ...
      if ($('.courses_slider').length) {
        ...
        $('.courses-carousel-btn .left-btn').on('click', function() {
          $('.courses_slider').trigger('prev.owl.carousel');
          return false;
        });
        $('.courses-carousel-btn .right-btn').on('click', function() {
          $('.courses_slider').trigger('next.owl.carousel');
          return false;
        });
      }
      ...
      if ($('.ebooks-slider').length) {
        ...
        $('.course-wrapper .course-ebooks-list .ebook-item').on('click', function() {
          var clicked_ebook_item_index = $(this).data('index');
