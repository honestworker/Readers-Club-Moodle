$(function() {
  ...
  if ($(".block_cocoon_courses_banner").length) {
    $banner = $(".block_cocoon_courses_banner");
    $(".inner_page_breadcrumb").replaceWith($banner);
    $("body").addClass("ccn_hero").removeClass("ccn_no_hero");
    $banner.addClass("ccn_morphed");
  }
  if ($(".block_cocoon_modern_slider").length) {
    $slider = $(".block_cocoon_modern_slider");
    $(".inner_page_breadcrumb").replaceWith($slider);
    $("body").addClass("ccn_hero").removeClass("ccn_no_hero");
    $slider.addClass("ccn_morphed");
  }
