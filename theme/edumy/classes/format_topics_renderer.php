...
class theme_edumy_format_topics_renderer extends format_topics_renderer {
   ...
   * @param int $displaytab The tab in the course which is being displayed
   */
  public function print_single_section_page($course, $sections, $mods, $modnames, $modnamesused, $displaysection, $displaytab) {
      global $PAGE;
